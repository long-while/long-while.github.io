import svgPaths from "./svg-t94cb1ciwg";
...
function Link() {
  return (
    <button aria-label="Redirect to brand strategy section of page" className="block content-stretch cursor-pointer flex font-['Rethink_Sans:Medium',sans-serif] font-medium items-start leading-[0] p-0 size-full text-left" data-name="Link">
...
function Link1() {
  return (
    <button aria-label="Redirect to personality section of page" className="block content-stretch cursor-pointer flex font-['Rethink_Sans:Medium',sans-serif] font-medium items-start leading-[0] p-0 size-full text-left" data-name="Link">
      <div className="css-g0mm18 flex flex-col justify-center relative shrink-0 text-[15px] text-black tracking-[-0.3px]">
...
function Link2() {
  return (
    <button aria-label="Redirect to logo section of page" className="block content-stretch cursor-pointer flex font-['Rethink_Sans:Medium',sans-serif] font-medium items-start leading-[0] p-0 size-full text-left" data-name="Link">
      <div className="css-g0mm18 flex flex-col justify-center relative shrink-0 text-[15px] text-black tracking-[-0.3px]">
...
function Link3() {
  return (
    <button aria-label="Redirect to color section of page" className="block content-stretch cursor-pointer flex font-['Rethink_Sans:Medium',sans-serif] font-medium items-start leading-[0] p-0 size-full text-left" data-name="Link">
      <div className="css-g0mm18 flex flex-col justify-center relative shrink-0 text-[15px] text-black tracking-[-0.3px]">
...
function Link4() {
  return (
    <button aria-label="Redirect to typography section of page" className="block content-stretch cursor-pointer flex font-['Rethink_Sans:Medium',sans-serif] font-medium items-start leading-[0] p-0 size-full text-left" data-name="Link">
      <div className="css-g0mm18 flex flex-col justify-center relative shrink-0 text-[15px] text-black tracking-[-0.3px]">
...
function Link5() {
  return (
    <button aria-label="Redirect to art direction section of page" className="block content-stretch cursor-pointer flex font-['Rethink_Sans:Medium',sans-serif] font-medium items-start leading-[0] p-0 size-full text-left" data-name="Link">
      <div className="css-g0mm18 flex flex-col justify-center relative shrink-0 text-[15px] text-black tracking-[-0.3px]">
...
function Contents() {
  return (
    <div className="relative shrink-0 w-full" data-name="Contents">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <ol className="content-stretch flex flex-col gap-[10px] items-start pb-[30px] pl-[32px] pr-[20px] pt-0 relative rounded-[inherit] w-full">
...
function Text() {
  return (
    <div className="content-stretch flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium items-start leading-[0] relative shrink-0 text-[#575757] text-[0px] tracking-[-0.3px]" data-name="Text">
...
function ContactUs() {
  return (
    <div className="relative shrink-0 w-full" data-name="Contact us">
      <div className="content-stretch flex flex-col items-start pl-[32px] pr-[20px] py-0 relative w-full">
        <Text />
      </div>
    </div>
  );
...
function Navigation() {
  return (
    <nav className="bg-white content-stretch flex flex-col gap-[24px] items-start pb-[30px] pt-0 px-0 shrink-0 sticky top-0 w-[250px]" data-name="Navigation">
      <Logo />
      <Contents />
      <ContactUs />
    </nav>
...
function ColorSection() {
  return (
    <section className="content-stretch flex flex-col gap-[30px] items-start pb-0 pt-[32px] px-[32px] relative shrink-0 w-[1030px]" data-name="Color section">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-l border-solid border-t inset-0 pointer-events-none" />
      <Header3 />
      <ColorPalette />
    </section>
...
function Header5() {
  return (
    <div className="content-stretch flex gap-[64px] h-[182px] items-start px-0 py-[32px] relative shrink-0 w-full" data-name="Header">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-solid border-t inset-0 pointer-events-none" />
      <SectionHeader9 />
...
function TypeStyles() {
  return (
    <div className="relative shrink-0 w-full" data-name="Type styles">
      <div className="content-stretch flex flex-col gap-[100px] items-start px-[32px] py-0 relative w-full">
        <Styles />
        <Sizing />
      </div>
    </div>
...
function ArtDirectionSection() {
  return (
    <section className="content-stretch flex flex-col gap-[65px] items-start p-0 relative shrink-0 w-[1030px]" data-name="Art Direction Section">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-l border-solid border-t inset-0 pointer-events-none" />
      <Header6 />
      <PhotoGrid />
    </section>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Footer">
      <div className="flex flex-row items-end size-full">
        <div className="content-stretch flex gap-[59px] items-end px-[40px] py-0 relative w-full">
          <Content8 />
          <Text2 />
        </div>
      </div>
...
function Legal() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative" data-name="Legal">
      <div className="css-g0mm18 flex flex-col justify-center relative shrink-0 text-[13px]">
        <p className="css-ew64yg leading-[1.2]">© Redo</p>
      </div>
      <div className="css-g0mm18 flex flex-col justify-center relative shrink-0 text-[0px]">
...
function Text3() {
  return (
    <div className="content-stretch flex font-['Rethink_Sans:Medium',sans-serif] font-medium gap-[16px] items-start leading-[0] relative shrink-0 text-black tracking-[-0.13px] w-full" data-name="Text">
      <Legal />
      <div className="css-g0mm18 flex flex-col justify-center relative shrink-0 text-[13px]">
