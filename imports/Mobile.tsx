import svgPaths from "./svg-9zi2frholt";
...
function Hero() {
  return (
    <div className="h-[262px] relative shrink-0 w-full" data-name="Hero">
...
function Content() {
  return (
    <div className="content-stretch flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium gap-[32px] items-start relative shrink-0 w-full" data-name="Content">
      <div className="flex flex-col justify-center leading-[0] relative shrink-0 text-[60px] text-black tracking-[-0.6px] w-full">
        <h1 className="block css-4hzbpn leading-[1.1]">Brand Guidelines</h1>
      </div>
      <div className="flex flex-col justify-center leading-[1.2] relative shrink-0 text-[#575757] text-[15px] tracking-[-0.15px] w-full">
...
function IntroSection() {
  return (
    <section className="relative shrink-0 w-full" data-name="Intro section">
      <div className="content-stretch flex flex-col items-start pb-[80px] pt-[32px] px-[20px] relative w-full">
        <Content />
      </div>
    </section>
  );
...
function List() {
  return (
    <ol className="content-stretch flex flex-col gap-[10px] items-start p-0 relative shrink-0 w-full" data-name="List">
      <List1 />
      <List2 />
      <List3 />
      <List4 />
  ...
  return (
    <section aria-label="Table of contents" className="relative shrink-0 w-full" data-name="Table of contents">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[30px] items-start pb-[80px] pt-[32px] px-[20px] relative w-full">
...
function StrategySection() {
  return (
    <section className="content-stretch flex flex-col items-start pb-[80px] pt-[32px] px-[20px] relative shrink-0 w-[375px]" data-name="Strategy section">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-solid border-t inset-0 pointer-events-none" />
      <Header />
    </section>
  );
...
function Examples() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start justify-center leading-[0] relative shrink-0 text-[15px] tracking-[-0.15px] w-full" data-name="Examples">
      <Row />
      <Row1 />
      <Row2 />
    </div>
...
function ToneAndVoice() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start px-0 py-[32px] relative shrink-0 w-full" data-name="Tone and voice">
      <Title2 />
      <Examples />
    </div>
  );
...
function Sample3() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Sample 4">
      <div className="flex flex-col font-['Rethink_Sans:Bold',sans-serif] font-bold justify-center relative shrink-0 text-black w-full">
...
function Sample2() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Sample 3">
      <div className="flex flex-col font-['Rethink_Sans:Bold',sans-serif] font-bold justify-center relative shrink-0 text-black w-full">
...
function Sample1() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Sample 2">
      <div className="flex flex-col font-['Rethink_Sans:Bold',sans-serif] font-bold justify-center relative shrink-0 text-black w-full">
...
function Sample() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Sample 1">
      <div className="flex flex-col font-['Rethink_Sans:Bold',sans-serif] font-bold justify-center relative shrink-0 text-black w-full">
...
function Samples() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start leading-[0] relative shrink-0 text-[15px] tracking-[-0.15px] w-full" data-name="Samples">
      <Sample3 />
      <Sample2 />
      <Sample1 />
      <Sample />
...
function PersonalitySection() {
  return (
    <div aria-label="Section 2 out of 6" className="content-stretch flex flex-col gap-[30px] items-start pb-[80px] pt-[32px] px-[20px] relative shrink-0 w-[375px]" data-name="Personality Section">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-solid border-t inset-0 pointer-events-none" />
      <Header1 />
      <Img />
      <ToneAndVoice />
...
function Diagram() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[420px] items-start pb-0 pt-[40px] px-0 relative shrink-0 w-full" data-name="Diagram 1">
      <SectionHeader1 />
      <Img1 />
    </div>
  );
...
function Img10() {
  return (
    <div className="h-[173px] relative shrink-0 w-full" data-name="IMG">
      <img alt="Image of partnership logos" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgImg10} />
    </div>
  );
}
...
function LogoSection() {
  return (
    <section className="content-stretch flex flex-col gap-[30px] items-center pb-[80px] pt-[32px] px-[20px] relative shrink-0 w-[375px]" data-name="Logo section">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-solid border-t inset-0 pointer-events-none" />
      <Header2 />
      <LogoDiagrams />
    </section>
...
function Color() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[357px] items-center relative shrink-0 w-[311px]" data-name="Color 1">
      <Img11 />
      <Label6 />
    </div>
  );
...
function Color1() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[357px] items-center relative shrink-0 w-[311px]" data-name="Color 2">
      <Img12 />
      <Label7 />
    </div>
  );
...
function Color2() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[357px] items-center relative shrink-0 w-[311px]" data-name="Color 3">
      <Img13 />
      <Label8 />
    </div>
  );
...
function Color3() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[357px] items-center relative shrink-0 w-[311px]" data-name="Color 4">
      <Img14 />
      <Label9 />
    </div>
  );
...
function Colors() {
  return (
    <div className="content-stretch flex flex-col h-[1548px] items-center justify-between relative shrink-0 w-full" data-name="Colors">
      <Color />
      <Color1 />
      <Color2 />
      <Color3 />
...
function ColorRow() {
  return (
    <div className="content-stretch flex flex-col h-[1548px] items-center justify-between relative shrink-0 w-full" data-name="Color row 1">
      <Color4 />
      <Color5 />
      <Color6 />
      <Color7 />
...
function Img20() {
  return <div aria-label="Black color swatch" className="bg-[#040404] flex-[1_0_0] min-h-px min-w-px rounded-[100000px] w-[311px]" data-name="IMG" />;
}
...
function Color9() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[357px] items-center relative shrink-0" data-name="Color 2">
      <Img20 />
      <Label15 />
    </div>
  );
...
function ColorRow1() {
  return (
    <div className="content-stretch flex flex-col h-[1476px] items-center justify-between relative shrink-0 w-full" data-name="Color row 2">
      <Color8 />
      <Color9 />
      <Color10 />
      <Color11 />
...
function Gradient() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="Gradient 1">
      <Img23 />
...
function Gradient1() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="Gradient 2">
      <Img24 />
      <div className="flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[0px] text-black tracking-[-0.13px] w-full">
...
function GradientRow() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full" data-name="Gradient row 1">
      <Gradient />
      <Gradient1 />
    </div>
  );
...
function GradientRow1() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full" data-name="Gradient row 2">
      <Gradient2 />
      <Gradient3 />
    </div>
  );
...
function ColorSection() {
  return (
    <section className="content-stretch flex flex-col gap-[30px] items-start pb-0 pt-[32px] px-[32px] relative shrink-0 w-[375px]" data-name="Color section">
...
function Img27() {
  return (
    <div className="aspect-[335/300] relative shrink-0 w-full" data-name="IMG">
...
function Header4() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start pb-[60px] pt-0 px-0 relative shrink-0 w-full" data-name="Header">
      <Title5 />
      <Content3 />
    </div>
  );
...
function Primary1() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Primary">
      ...
      <p className="css-4hzbpn font-['Rethink_Sans:Regular',sans-serif] font-normal leading-[1.3] relative shrink-0 text-[41px] tracking-[-0.82px] w-full">Rethink Sans Reg</p>
    </div>
  );
}
...
function Secondary1() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Secondary">
      ...
      <p className="css-4hzbpn font-['Hedvig_Letters_Serif:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[41px] tracking-[-0.82px] w-full">Hedvig Letters Serif</p>
    </div>
  );
}
...
function Header5() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start pb-[40px] pt-[32px] px-0 relative shrink-0 w-full" data-name="Header">
      <SectionHeader9 />
      <div className="flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#575757] text-[15px] tracking-[-0.15px] w-full">
...
function Content4() {
  return (
    <div className="content-stretch flex flex-col gap-[30px] items-start pb-[10px] pt-0 px-0 relative shrink-0 w-full" data-name="Content">
      ...
      <p className="css-4hzbpn font-['Hedvig_Letters_Serif:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[14px] text-black w-full">Financial errors shouldn’t slow you down or cause unnecessary stress. Whether it’s an incorrect charge, a duplicate transaction, or a miscalculated fee, we step in to make things right. Our process is simple, straightforward, and designed to get your money back where it belongs—quickly and without hassle.</p>
      <Description />
    </div>
  );
}
...
function Content6() {
  return (
    <div className="content-stretch flex flex-col gap-[30px] items-start px-0 py-[10px] relative shrink-0 w-full" data-name="Content">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="css-4hzbpn font-['Rethink_Sans:Regular',sans-serif] font-normal leading-[1.1] relative shrink-0 text-[32px] text-black tracking-[-0.64px] w-full">Whether it’s a bank error, an unauthorized charge, or an overlooked refund, we ensure you don’t pay for something you shouldn’t have.</p>
      <Description2 />
    </div>
  );
}
...
function Content7() {
  return (
    <div className="content-stretch flex flex-col gap-[30px] items-start pb-[10px] pt-0 px-0 relative shrink-0 w-full" data-name="Content">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <p className="css-4hzbpn font-['Rethink_Sans:Regular',sans-serif] font-normal leading-[1.1] relative shrink-0 text-[50px] text-black tracking-[-1px] w-full">Clear Up Confusion, Gain Peace of Mind</p>
      <Description3 />
    </div>
  );
}
...
function TypographySection() {
  return (
    <section className="content-stretch flex flex-col gap-[30px] items-start pb-[80px] pt-[32px] px-[20px] relative shrink-0 w-[375px]" data-name="Typography Section">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-solid border-t inset-0 pointer-events-none" />
      <Header4 />
      <TypeStyles />
    </section>
...
function Header6() {
  return (
    <div className="relative shrink-0 w-full" data-name="Header">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-solid border-t inset-0 pointer-events-none" />
      <div className="content-stretch flex flex-col gap-[12px] items-start pb-0 pt-[20px] px-[20px] relative w-full">
        <Title6 />
        <div className="flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#575757] text-[15px] tracking-[-0.15px] w-full">
...
function ArtDirectionSection() {
  return (
    <section className="content-stretch flex flex-col gap-[60px] items-start p-0 relative shrink-0 w-[375px]" data-name="Art Direction Section">
      <Header6 />
      <PhotoGrid />
    </section>
  );
...
function Group() {
  return (
    <div className="h-[63.185px] relative shrink-0 w-[270px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 270 63.1857">
        <g id="Group 2147220659">
          <g id="Redo">
            <path d={svgPaths.pa1d2820} fill="var(--fill-0, black)" id="Vector" />
            <path d={svgPaths.p19e1900} fill="var(--fill-0, black)" id="Vector_2" />
            <path d={svgPaths.p3eb498f0} fill="var(--fill-0, black)" id="Vector_3" />
            <path d={svgPaths.pe173fc0} fill="var(--fill-0, black)" id="Vector_4" />
          </g>
          <path clipRule="evenodd" d={svgPaths.p1b3ee0f0} fill="var(--fill-0, black)" fillRule="evenodd" id="Vector 2669 (Stroke)" />
          <path clipRule="evenodd" d={svgPaths.p1881ac80} fill="var(--fill-0, black)" fillRule="evenodd" id="Vector 2670 (Stroke)" />
        </g>
      </svg>
    </div>
  );
...
function Logo() {
  return (
    <div aria-label="Redo company logo" className="content-stretch flex flex-col items-start relative shrink-0" data-name="Logo">
      <Group />
    </div>
  );
}
...
function Text1() {
  return (
    <div className="content-stretch flex flex-col gap-[19px] items-start relative shrink-0" data-name="Text">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="flex flex-col justify-end size-full">
        <div className="content-stretch flex flex-col gap-[59px] items-start justify-end px-[16px] py-0 relative w-full">
          <Logo />
          <Text1 />
        </div>
      </div>
...
function Content9() {
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-solid border-t inset-0 pointer-events-none" />
      <div className="flex flex-col justify-end size-full">
        <div className="content-stretch flex flex-col items-start justify-end pb-[20px] pt-[40px] px-[16px] relative w-full">
          <Text2 />
        </div>
      </div>
    </div>
...
function Footer() {
  return (
    <footer className="content-stretch flex flex-col gap-[31px] items-start pb-[32px] pt-[128px] px-0 relative shrink-0 w-full" data-name="Footer">
      <Content8 />
      <Content9 />
    </footer>
  );
...
function Logo1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-h-px min-w-px relative" data-name="Logo">
...
function Menu() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Menu">
      <div className="css-g0mm18 flex flex-col font-['Rethink_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[15px] text-black tracking-[-0.3px]">
        <p className="css-ew64yg leading-[1.2]">Menu</p>
      </div>
    </div>
  );
}
...
function MobileNav() {
  return (
    <nav className="absolute bg-white content-stretch flex flex-col items-start left-0 overflow-clip px-[16px] py-0 right-0 top-0" data-name="Mobile nav">
      <Content10 />
    </nav>
  );
}
