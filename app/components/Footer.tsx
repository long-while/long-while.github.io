          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div>
              ...
              <nav className="space-y-1">
                ...
                >
                  크레페 <ExternalLinkIcon className="w-3 h-3 inline" />
                </a>
              </nav>
            </div>
          </div>
          ...
          <div className="md:pl-8 md:border-l border-border">
            ...
            <div className="space-y-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-[15px] font-medium text-[var(--brand-primary)] hover:text-[var(--brand-primary-hover)] transition-colors focus-visible:outline-2 focus-visible:outline-[var(--brand-primary)] focus-visible:outline-offset-2"
              >
                크레페 DM 바로가기 →
              </a>
              <div className="text-[14px] text-foreground/70 space-y-1">
