      ...
      <div className="max-w-[1200px] mx-auto px-8 py-8">
        <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6">
          <button
            ...
            className="text-[16px] font-medium text-black hover:text-[#ff7b00] transition-colors"
          >
            홈으로
          </button>
          <button
          ...
          <a
            ...
            className="text-[16px] font-medium text-[#ff7b00] hover:text-[#e66d00] transition-colors"
          >
            커미션 신청하러 가기!
          </a>
        </div>
