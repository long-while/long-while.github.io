...
/**
 * FAQ 항목.
 * 홈 화면 렌더링과 빌드 타임 FAQPage 구조화 데이터(scripts/prerender.mjs) 양쪽에서 사용하므로
 * 컴포넌트 밖에 두고 내보낸다. 구조화 데이터는 question/answer 문자열만 사용한다.
 */
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: "아니요. 마스토돈 가이드는 서버 설치 커미션을 신청하시면 무료로 제공됩니다. 별도로 신청하지 않으셔도 서버를 설치해드릴 때 노션 페이지 링크로 함께 전달드려요. 다만 가이드는 기본 트위터 블루 테마가 적용된 캡처 화면으로 제작되며, 각 서버의 테마가 적용된 가이드는 제공하지 않습니다. 타 플랫폼은 쓰지 않으며, 한달 후 링크가 삭제됩니다."
  },
  {
